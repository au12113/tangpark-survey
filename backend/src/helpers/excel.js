...
const writeExcel = async (jsonSheet, filename, subFolder=undefined) => {
  ...
  if (__argv['mode'] == 'mapping') {
    ...
    // "GPS(Lat,Long)"]
    ws_column = ["สาขาที่ออกเยี่ยม", "วันที่ออกเยี่ยม", "ชื่อscที่ออกเยี่ยม ", "ชื่อกลุ่ม และ/หรือหัวหน้ากลุ่ม", "ชื่อลูกค้า ", "ประเภทธุรกิจ", "ประเภทสินค้าที่ขนส่ง เช่น ยางพารา",
